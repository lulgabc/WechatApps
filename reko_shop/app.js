        ...
        if (res.authSetting['scope.userInfo']) {
          ...
          wx.getUserInfo({
            success: res => {
              ...
              // 跟新shop基本信息：name,country,province,city,phone,avatar
              let that = this
              ...
              wx.request({
                ...
                success: function (res) {
                  console.log("Update Shop Userinfo success: code:", res.statusCode)
                }
